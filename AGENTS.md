...
19. **市场分析页（PPT）**：新增「市场分析」幻灯片，用公开权威数据论证金融道德风险高发（全球洗钱 1.6 万亿、FINRA 近5年纪律处分 3,490 起、罚款追缴 4.4 亿美元等），配柱状图，论证合规工具是刚需
...
- 2026-08-26：本地(离线)分类器加关键词加权(越具体词权重越高)+否定词处理；本地改写加行为分类模板兜底（提升离线识别与改写准确性）
- 2026-08-26：PPT 新增「市场分析」页，用公开权威数据（UNODC 洗钱 1.6 万亿、FINRA 纪律处分 3,490 起/罚款 4.4 亿）论证合规工具刚需，配柱状图；同步更新报告/大纲/讲解词
